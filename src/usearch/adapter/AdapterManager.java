...
public class AdapterManager {
	...
	private List<DeviceItem> mDeviceList;   //设备集合
	 ...
	 * @param bluetoothDevice
	 */
	public void changeDevice(int listId, DeviceItem DeviceItem){
		mDeviceList.remove(listId);
		mDeviceList.add(listId, DeviceItem);
	}

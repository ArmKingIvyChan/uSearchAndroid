...
import usearch.adapter.FileListAdapter;
...
public class SelectFileActivity extends Activity {
	...
	private OnClickListener mEnsureBtnClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			intent.putExtra(SearchActivity.SEND_FILE_NAME, file.getAbsolutePath());
			SelectFileActivity.this.setResult(SearchActivity.RESULT_CODE, intent);
			SelectFileActivity.this.finish();
		}
	};
